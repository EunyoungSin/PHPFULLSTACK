...
// const url2 = "https://picsum.photos/v2/list?page=2&limit=100";
...
function makeList(data) {
    ...
    data.forEach(item => {
        ...
        imageContainer.appendChild(tagImg);
    });
}

// 초기화면 로드 시 이미지 표시
const initialURL = 'https://picsum.photos/v2/list?page=1&limit=5'; // 초기 이미지 URL
    fetch(initialURL)
    .then(res => {return res.json()})
    .then(data => makeList(data))
    .catch(console.log);
