...
class TasksController extends Controller
{
    ...
    {
        // $arrId = $request->only(['id']);
        // $arrPw = $request->only(['pw']);
        $arrId = $request->all();
        // return 'Tasks.store! <br> ID : '.$arrId['id'].' PW : '.$arrPw['pw'];
        return 'Tasks.store! <br> ID : '.$request->id.' PW : '.$request->pw; // $request가 Request 객체기 때문에 받아올 수 있음
    }
